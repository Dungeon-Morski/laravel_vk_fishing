...
@section('content')
    <header class="header py-4 flex items-center justify-center rounded-b-[20px] md:rounded-b-none">
        <div class="container">
            ...
            <div class="banner pt-7 flex justify-between gap-2 items-center md:hidden">
                <div class="flex justify-center  items-center">
                    <div class="banner__icon">
                        <img src="{{ asset('img/mobile_new.png') }}" alt="">
                    </div>
                    <a href="#" class="banner__text">Установить приложение <b>ВКонтакте</b></a>
                </div>
                <div class="banner__arrow">
                    <img src="{{ asset('img/blue_arrow.png') }}" alt="">
                </div>
            </div>
    ...
    <main>
        <div class="wrapper">
            <div class="n-banner py-3 hidden md:block">
                <div class="banner descktop__banner flex justify-between gap-2 items-center">
                    <div class="flex justify-center  items-center">
                        <div class="banner__icon">
                            <img src="{{ asset('img/mobile_new.png') }}" alt="">
                        </div>
            ...
            <div class="main__block pt-6 mt-3 md:mt-0">
                <div class="container ">
                    <div class="flex flex-col gap-2">
                        <h1 class="text-white">Вход ВКонтакте</h1>
                        <p class="main__text">
                            Мобильная версия поможет вам оставаться ВКонтакте, даже если вы далеко от компьютера.
                        </p>
                        <a class="btn flex justify-center items-center" href="{{route('mobile-auth.index')}}" rel="noopener">Войти по телефону или почте</a>
                    </div>
                </div>
            </div>
            <div class="second__block">
                <div class="container">
                    <a class="btn flex justify-center items-center" href="" rel="noopener">Зарегистрироваться</a>
                </div>
            </div>
            <div class="last__block">
                <div class="container">
                    <ul class="language flex justify-center flex-wrap">
                        <li>Українська</li>
                        <li>English</li>
                        <li>all languages »</li>
                    </ul>
                    <div class="site__version text-center mt-1">
                        <p>Версия для компьютера</p>
                    </div>
                </div>
            </div>
        </div>
